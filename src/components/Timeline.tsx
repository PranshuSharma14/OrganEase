...
export function generateTimelineSteps(match: Match): TimelineStep[] {
  ...
  // Step 7: Certificate/Letter Generated
  if (match.consentPdfUrl) {
    steps.push({
      title: "Certificate Generated",
      description: "Completion certificate has been generated by the hospital",
      status: "completed",
    });
  } else {
    steps.push({
      title: "Certificate",
      description: "Awaiting certificate generation by hospital",
      status: "current",
    });
  }
